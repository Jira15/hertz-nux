...
import { u as useActualizarStore } from './actualizar-63b043bb.mjs';
      ...
      async onSubmit() {
        ...
        await $fetch("/api/tarjeta", {
          ...
          if (respuesta.includes(codigoAprobado)) {
            ...
            console.log("Transacci\xF3n Aprobada" + orderId);
...
//# sourceMappingURL=_id_-6ce5c033.mjs.map
