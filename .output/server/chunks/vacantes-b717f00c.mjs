...
import { d as defineStore, u as useDirectusItems, _ as _export_sfc, e as useRouter, f as useHead } from './server.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'destr';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Lista de Vacantes | Hertz Rent a Car Panam\xE1"
    });
...
export { vacantes as default };
//# sourceMappingURL=vacantes-b717f00c.mjs.map
