...
import { _ as _export_sfc, f as useHead, a as __nuxt_component_0$2 } from './server.mjs';
import { defineComponent, ref, provide, watch, onMounted, onBeforeUnmount, withScopeId, pushScopeId, popScopeId, openBlock, createBlock, createVNode, renderSlot, toRef, inject, Fragment, createCommentVNode, withDirectives, vShow, computed, Comment, markRaw, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import { a as useSucursalStore, u as useSearchStore } from './TheSearch-6c2f2ca9.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Sucursales | Hertz Rent a Car Panam\xE1"
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(sucursales2), (sucursal) => {
        ...
        if (sucursal.imagen) {
          ...
          _push(ssrRenderComponent(unref(F), {
...
export { sucursales as default };
//# sourceMappingURL=sucursales-1ddfa294.mjs.map
