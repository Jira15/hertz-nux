import { ref, useSSRContext, computed, resolveComponent, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<form${ssrRenderAttrs(mergeProps({ class: "reservador" }, _attrs))}><article><h2>Reserva tu veh\xEDculo</h2><div class="sucursales"><section><legend>sucursal de retiro</legend><label class="sucursal"><select name="sucursal" as="select" rules="required"><option disabled value="">Selecciona una sucursal</option><!--[-->`);
...
export { __nuxt_component_1 as _, useSucursalStore as a, useSearchStore as u };
//# sourceMappingURL=TheSearch-6c2f2ca9.mjs.map
