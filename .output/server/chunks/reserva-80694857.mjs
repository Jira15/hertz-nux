...
import { u as useAutosStore, _ as _imports_0, a as __nuxt_component_1 } from './promo-de413b6d.mjs';
import { _ as _export_sfc, b as useRoute, f as useHead, e as useRouter, a as __nuxt_component_0$2 } from './server.mjs';
...
import { u as useSearchStore } from './TheSearch-6c2f2ca9.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      title: "Reservas | Hertz Rent a car Panam\xE1"
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(autos), (auto) => {
        ...
        if (auto.status === "disponibilidad") {
          _push(`<section class="disponibilidad" data-v-8f0b12d4><section data-v-8f0b12d4><div data-v-8f0b12d4><em data-v-8f0b12d4>Por d\xEDa</em><h4 data-v-8f0b12d4>${ssrInterpolate(precioFormat(auto.precio_hertz))}</h4></div><div data-v-8f0b12d4><em data-v-8f0b12d4>Prepago</em><h4 data-v-8f0b12d4>${ssrInterpolate(precioPrepago(auto.precio_hertz))}</h4></div></section>`);
...
export { reserva as default };
//# sourceMappingURL=reserva-80694857.mjs.map
