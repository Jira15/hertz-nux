...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(be), {
        "slide-ratio": 1 / 2,
        "fixed-height": "350px",
        arrows: false,
        bullets: false,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(banner), (banner2) => {
              _push2(ssrRenderComponent(unref(Z), {
                key: banner2.id,
...
const _imports_0 = "" + buildAssetsURL("corpo1.0779bdda.jpg");
const _imports_1 = "" + buildAssetsURL("usa1.da7d731b.jpg");
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-d0354da5.mjs.map
