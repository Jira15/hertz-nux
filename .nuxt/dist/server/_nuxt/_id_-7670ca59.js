import { _ as __nuxt_component_0, a as __nuxt_component_1 } from "./Desglose-93ee481e.js";
import { d as defineStore, u as useDirectusItems, _ as _export_sfc, b as useRoute, a as __nuxt_component_0$1 } from "../server.mjs";
import { computed, mergeProps, unref, useSSRContext, defineComponent, ref, withAsyncContext, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderAttr, ssrLooseContain, ssrRenderComponent } from "vue/server-renderer";
import { u as usePedidoStore } from "./pedido-45937ac8.js";
import "hookable";
import "destr";
import "devalue";
import "./ac-18281470.js";
import "./get-asset-url-9698b8ce.js";
...
const Coberturas_vue_vue_type_style_index_0_scoped_c55a053b_lang = "";
const _sfc_main$2 = {
  __name: "Coberturas",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(coberturas), (cobertura) => {
        ...
        if (unref(storePedido).pedido.carro.tipo != "Sedan") {
          _push(`<footer data-v-c55a053b><h4 data-v-c55a053b>B/. ${ssrInterpolate(cobertura.precio_2)} / por día</h4><input required type="radio" name="cobertura"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(storePedido).pedido.cobertura, cobertura)) ? " checked" : ""}${ssrRenderAttr("value", cobertura)} data-v-c55a053b></footer>`);
        } else {
          _push(`<footer data-v-c55a053b><h4 data-v-c55a053b>B/. ${ssrInterpolate(cobertura.precio)} / por día</h4><input required type="radio" name="cobertura"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(storePedido).pedido.cobertura, cobertura)) ? " checked" : ""}${ssrRenderAttr("value", cobertura)} data-v-c55a053b></footer>`);
        }
        _push(`</article></li>`);
      });
      _push(`<!--]--><li data-v-c55a053b><article data-v-c55a053b><div data-v-c55a053b><header data-v-c55a053b><h3 data-v-c55a053b>Asistencia Vial(ERA)</h3></header><p data-v-c55a053b> ERA | ASISTENCIA VIAL Esta cobertura ofrece a EL ARRENDATARIO los siguientes servicios de asistencia en carretera sin cargo alguno: Pérdida de llave del automóvil, servicio de grúa, reemplazo de neumático, asistencia al quedarse sin combustible o sin batería. El tiempo de respuesta por parte de LA ARRENDADORA está sujeto al día, hora y ubicación del incidente. </p></div><footer data-v-c55a053b><h4 data-v-c55a053b>B/. 3.99 / por día</h4></footer></article></li></ul></section></main>`);
    };
  }
};
...
const _id__vue_vue_type_style_index_0_scoped_d7274c79_lang = "";
const _sfc_main = {
  __name: "[id]",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=_id_-7670ca59.js.map
