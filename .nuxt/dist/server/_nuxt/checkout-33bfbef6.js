...
import { ref, computed, mergeProps, unref, useSSRContext, resolveComponent, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
import { u as usePedidoStore } from "./pedido-45937ac8.js";
import { d as defineStore, u as useDirectusItems, e as useRouter, _ as _export_sfc } from "../server.mjs";
import "hookable";
import "destr";
import "devalue";
...
const checkout_vue_vue_type_style_index_0_scoped_7459dfb0_lang = "";
const _sfc_main = {
  __name: "checkout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</p><p data-v-7459dfb0><label for="telefono" data-v-7459dfb0>Teléfono</label>`);
      _push(ssrRenderComponent(unref(Field), {
      ...
      _push(`</p><p data-v-7459dfb0><label for="email" data-v-7459dfb0>Correo electrónico</label>`);
      _push(ssrRenderComponent(unref(Field), {
...
//# sourceMappingURL=checkout-33bfbef6.js.map
