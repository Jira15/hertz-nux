import { computed, unref, useSSRContext, mergeProps } from "vue";
...
const CarroSeleccionado_vue_vue_type_style_index_0_scoped_257ab4b2_lang = "";
const _sfc_main$1 = {
...
const Desglose_vue_vue_type_style_index_0_lang = "";
const __default__ = {
  components: {
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "desglose" }, _attrs))}><h6>Detalles:</h6><dl><dt> Retiro:<br>${ssrInterpolate(unref(pedido).sucursal.name)}</dt><dd> Retorno: <br>${ssrInterpolate(unref(pedido).sucursalRetorno.name)}</dd></dl><dl><dt> Día de Retiro: </dt><dd>${ssrInterpolate(fechaFormat(unref(pedido).diaRetiro))}</dd></dl><dl><dt> Día de Retorno: </dt><dd>${ssrInterpolate(fechaFormat(unref(pedido).diaRetorno))}</dd></dl>`);
...
//# sourceMappingURL=Desglose-93ee481e.js.map
